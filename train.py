...
tf.app.flags.DEFINE_string("train_log", "train.log", "Training log.")
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        ...
        model.train(sess, FLAGS.train_dir, train_set, val_set, FLAGS.steps_per_checkpoint, FLAGS.train_log)
        print("final best perplexity is: %f" % model.min_ppl)
